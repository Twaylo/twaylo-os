...
const AIDE = [
  ...
  "",
  "Tout ce que tu fais à l'écran, tu peux me le dire.",
  "",
  "Exemples :",
  "• « ajoute une tâche : monter le short »",
  "• « coche l'intro Somalie » · « passe ça en focus principal »",
  "• « enlève la tâche X » (elle part dans les Oubliés)",
  "• « j'ai fait mon sport, gym »",
  "• « les shorts partent au monteur » · « je les ai reçus » · « postés »",
  "• « aujourd'hui je vais boucler le format long »",
  "• « ça coince : le monteur ne répond pas » · « c'est débloqué »",
  "• « monte mon espagnol à 45 »",
  "• « je pars en déplacement » (change la journée type)",
