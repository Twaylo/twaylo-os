...
export const MODULES: Module[] = [
  ...
  },
  {
    ...
    profils: ["etudiant", "actif", "sportif", "autre", "createur"],
  },
  {
    id: "Skill",
    emoji: "📈",
    description: "Tes compétences notées chaque semaine, et leur courbe.",
    profils: ["etudiant", "sportif", "createur", "autre"],
  },
  {
    id: "Brain",
    emoji: "🧠",
...
export const BLOCS: BlocAccueil[] = [
  ...
  },
  {
    ...
    profils: ["etudiant", "actif", "independant", "autre"],
  },
  {
    id: "semaine",
    titre: "La semaine",
